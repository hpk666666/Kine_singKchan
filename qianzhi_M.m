...
VK=-77*10^-3;%单位是 V
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
M=linspace(0.1*10^-12,10*10^-12,n);%定义膜面积，单位是m^2
data_1=cell(1,n);
data_2=cell(1,n);
data_3=cell(1,n);
data_4=cell(1,n);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
format short e
data_1{1,i}=VL_diedai(1,u_VL{1,i},ddai,Ve(i),VL_star(i),E,Ka_L,Lb_L,L);%1,2,3,4分别代表四个不同的u值的pi
data_2{1,i}=VL_diedai(2,u_VL{1,i},ddai,Ve(i),VL_star(i),E,Ka_L,Lb_L,L);
data_3{1,i}=VL_diedai(3,u_VL{1,i},ddai,Ve(i),VL_star(i),E,Ka_L,Lb_L,L);
data_4{1,i}=VL_diedai(4,u_VL{1,i},ddai,Ve(i),VL_star(i),E,Ka_L,Lb_L,L);
data{1,i}=Ve_diedai(u_Ve(i),ddai,Ve(i),VL_star(i),E,Ka_e,Lb_e,L);
end
